...
- [ ] **OpenAPI spec obtained** — A real OpenAPI 3.0 spec exists (`data/openapi.json`, auto-generated by `scripts/openapi_generator.py`) but is not yet exposed at a public URL; request a copy from your CSM until a public endpoint ships
